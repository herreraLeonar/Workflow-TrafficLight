...
namespace HelloWorldActivities {
    ...
    public partial class RandomLooper : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(RandomLooper).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(RandomLooper));
        ...
        private string FindResource() {
            string[] resources = typeof(RandomLooper).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".RandomLooper.g.xaml") || resource.Equals("RandomLooper.g.xaml"))) {
                    return resource;
                }
            }
