...
namespace HelloWorldActivities {
    ...
    public partial class HelloWorld : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(HelloWorld).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(HelloWorld));
        ...
        private string FindResource() {
            string[] resources = typeof(HelloWorld).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".HelloWorld.g.xaml") || resource.Equals("HelloWorld.g.xaml"))) {
                    return resource;
                }
            }
